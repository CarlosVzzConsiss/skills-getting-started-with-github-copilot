...
activities = {
    ...
    "Soccer Club": {
        ...
        "max_participants": 18,
        "participants": ["karla@mergington.edu", "raul@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Club": {
        ...
        "max_participants": 20,
        "participants": ["lena@mergington.edu", "maria@mergington.edu"]
    },
    "Science Club": {
        "description": "Conduct experiments and explore scientific concepts",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["sam@mergington.edu", "rachel@mergington.edu"]
    },
    "Debate Team": {
        "description": "Research current topics and develop public speaking skills",
